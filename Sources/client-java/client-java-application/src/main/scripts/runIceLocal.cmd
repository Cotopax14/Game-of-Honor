...
"%JAVA_HOME%/bin/java" -classpath config;%APP_CLASSPATH% %CLIENT_OPTIONS% -Djava.library.path=natives com.ospgames.goh.clientjava.IceClient --Ice.Config=config/ice-config.properties
goto :end
